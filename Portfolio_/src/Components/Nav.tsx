...
function Nav() {
  return (
    <>
      <nav className=' w-full bg-black text-white h-fit   font-sans content-center justify-items-center '>
          <ul className='invisible md:visible flex flex-row py-4  content-center my-5 justify-center text-center items-center text-purple-400 bg-gray-900 max-w-max h-[70%] px-2 rounded-4xl '>
            ...
            <li className='mr-2  hover:text-white content-center text-center '><Link to="https://www.linkedin.com/in/olarewaju-adebulu-320184212/"><FaLinkedin size={15}/></Link></li>
